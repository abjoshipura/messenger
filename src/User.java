...
public class User {
    ...
    // List of all users who cannot message this user.
    private ArrayList<User> blockedUsers;

    // List of all users who cannot search for this user.
    private ArrayList<User> invisibleUsers;

    // List of all Strings that need to be censored in this user's viewing of the file
    private ArrayList<String> censoredWords;

    // Creates generic user object based on user String contents from a preexisting User.
    // User<username, email, password, blocked Users, invisible users, censored words>
    ...
    // Creates entirely new User object from inputted parameters.
    ...
    // Finds this User and changes this users username
    ...
    // Finds this user and changes the password
    ...
    // Changes whether user does or does not censor certain words.
    ...
    // Add a user to be blocked to prevent messaging from that user.
    ...
    // Takes off user from blocked list and allows messages from them again.
    ...
    // Adds user to invisiblity list and prevents them from finding this user.
    ...
    // Removes user from invisiblity list and allows them to find this user again.
    ...
    // Adds a new word to be censored.
    ...
    // Removes a word from being censored.
    ...
    // Sends a message to a conversation file shared between this and the other user.
    ...
    // Takes a specific message and replaces it with a new message.
    ...
    // Removes a specific message from a conversation file.
